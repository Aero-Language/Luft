...
public sealed class ClassSymbol(string name, AccessMod access, ModuleSymbol module, SourceSpan span)
    : TypeSymbol(name, access, module, span)
{
...
public sealed class StructSymbol(string name, AccessMod access, ModuleSymbol module, SourceSpan span)
    : TypeSymbol(name, access, module, span)
{
    public ValueList<AeroType> Implements { get; init; } = ValueList<AeroType>.Empty;
}

public sealed class TraitSymbol(string name, AccessMod access, ModuleSymbol module, SourceSpan span)
    : TypeSymbol(name, access, module, span)
{
    public ValueList<AeroType> Traits { get; init; } = ValueList<AeroType>.Empty; // traits this trait itself extends
}

public sealed class RecordSymbol(string name, AccessMod access, ModuleSymbol module, SourceSpan span)
    : TypeSymbol(name, access, module, span)
{
    public ValueList<AeroType> Implements { get; init; } = ValueList<AeroType>.Empty;
}

public sealed class AnnotationSymbol(string name, AccessMod access, ModuleSymbol module, SourceSpan span)
    : TypeSymbol(name, access, module, span);

public sealed class EnumSymbol(string name, AccessMod access, ModuleSymbol module, SourceSpan span)
    : TypeSymbol(name, access, module, span)
{
